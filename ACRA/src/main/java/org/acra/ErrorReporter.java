...
public class ErrorReporter implements UncaughtExceptionHandler {
        ...
        if (filesList != null && filesList.length > 0) {
            ...
            if (reportingInteractionMode == ReportingInteractionMode.SILENT
                ...
                if (reportingInteractionMode == ReportingInteractionMode.TOAST && !onlySilentOrApprovedReports) {
                    ...
                    // non-silent reports.
                    ToastSender.sendToast(mContext, ACRA.getConfig().toastText(), Toast.LENGTH_LONG);
                }
    ...
    private void handleException(Throwable e, ReportingInteractionMode reportingInteractionMode,
        ...
        final boolean shouldDisplayToast = reportingInteractionMode == ReportingInteractionMode.TOAST
                || (!ACRA.getConfig().toastText().isEmpty() && (reportingInteractionMode == ReportingInteractionMode.NOTIFICATION || reportingInteractionMode == ReportingInteractionMode.DIALOG));
    ...
    private void notifySendReport(String reportFileName) {
        ...
        String channelId = "acra_crash_channel";
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
            ...
            channel.setDescription("Channel for crash report notifications");
        ...
        // deleteIntent para cuando se borra la notificación
        Intent deleteIntent = new Intent(mContext, CrashReportDialog.class);
        deleteIntent.putExtra(ACRAConstants.EXTRA_FORCE_CANCEL, true);
        PendingIntent pendingDeleteIntent = PendingIntent.getActivity(
                mContext,
                -1,
                deleteIntent,
        ...
        notificationManager.notify(ACRAConstants.NOTIF_CRASH_ID, builder.build());
    }
